window.settings.i18n['ko-KR'] = {
  ...
  '下单': '주문',
  '总计': '전체',
  '变更订阅会导致当前订阅被新订阅覆盖，请注意。': '구독을 변경하시면 현재 구독 트래픽/유효 기간이 재설정되므로 현재 남은 시간/트래픽을 기억해 주시면 작업 주문을 통해 보상해 드리겠습니다.',
  ...
  '对您当前的订阅进行续费': '갱신해도 트래픽이 증가하지 않으며 작업 주문은 무제한 패키지 갱신에 중첩될 수 있습니다.',
