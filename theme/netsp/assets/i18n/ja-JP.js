window.settings.i18n['ja-JP'] = {
  ...
  '下单': 'チェックアウト',
  '总计': '合計金額',
  '变更订阅会导致当前订阅被新订阅覆盖，请注意。': 'サブスクリプションを変更すると、現在のサブスクリプションのトラフィック/有効期間がリセットされることに注意してください。現在の残り時間/トラフィックを覚えておいてください。作業指示を通じて補償できます。',
  ...
  '对您当前的订阅进行续费': '更新によってトラフィックが増加することはなく、無制限のパッケージ更新に作業指示を重ね合わせることができます。',
